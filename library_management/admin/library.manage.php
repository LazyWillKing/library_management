<?php 
    ...
    $data = array();
    echo "<script>alert('所有书均被借出');window.location.href='library.php';</script>";
}
			...
			<div id="content_body">
                <table width="1000" border="0" cellpadding="8" cellspacing="1" bgcolor="#000000">
                  ...
                  <tr>
            		...
            		<td width="250" bgcolor="#FFFFFF">简介</td>
            	...
            	?>
                  <tr>
            	    ...
            	    if('<?php echo $value['borrow']?>'=='未借出'){
            	    	document.write('<a href="library.borrow.handle.php?id=<?php echo $value['id']?>">借阅</a>')
            	    }else {           	    
            	    	document.write('<a href="library.return_book.php?id=<?php echo $value['id']?>">还书</a>')
            	    }
            	    	</script>
